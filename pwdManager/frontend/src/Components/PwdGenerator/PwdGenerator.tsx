        ...
        <div className={GeneratorClass}>
            <div className={styles.generatorPannel}>
                ...
                <div className={styles.pwdDisplay}>
                    <input type={showPwd ? 'text' : 'password'} value={genetatedPwd} onChange={handleAttrChange}/>
                    {showPwd ? <img src={hiddenIcon} onClick={() => setShowPwd(false)} width={'30px'} height={'30px'} /> : <img src={showIcon} onClick={() => setShowPwd(true)} width={'30px'} height={'30px'} />}
                </div>
