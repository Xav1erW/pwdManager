...
def validate(
    ...
    # add modified_request_body to kwargs
    def decorate(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            if body_model:
                if kwargs.get("modified_request_body"):
                    body_params = kwargs["modified_request_body"]
                else:
            ...
            # 删除modified_request_body 防止发生错误
            if kwargs.get("modified_request_body"):
                del kwargs["modified_request_body"]
