import sys
sys.path.append('/home/pwd_manager/data')
import json
...
configPath = os.path.join(os.path.expanduser('~'), 'data/config.json')
...
def get_db_path():
    ...
    dbfolder = os.path.join(os.path.expanduser("~/data"), config['backend']['dbFolder'])
    return dbfolder
